...
Pod::Spec.new do |s|
  ...
  #pod的名称
  s.name         = "XESTestProject"
  #pod的版本
  s.version      = "0.0.1"
  #pod简介(最多140字符)
  s.summary      = "XESTestProject."
  #pod详细描述
  s.description  = <<-DESC
                    this is XESTestProject develop by xueersi Base component library team
                   DESC
  #项目主页地址
  s.homepage     = "https://github.com/hu646641434/XESTest"
  ...
  #库索引地址
  s.source       = { :git => "https://github.com/hu646641434/XESTest", :tag => s.version.to_s }

  #需要包含的源文件
  s.source_files  = "XESTestProject/**/*.{h,m}"
  #需要移除的文件
